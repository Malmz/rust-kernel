...
/// Struct for the active page table 4
///
/// There can only be one at the time!
pub struct Mapper {
...
impl Mapper {
	...
	/// It is unsafe because having more than one instance
	/// of this type can lead to unexpected behavior.
	pub unsafe fn new() -> Mapper {
		Mapper {
			p4: Unique::new(table::P4),
		}
	}
	/// Returns a referance to Page table 4
	pub fn p4(&self) -> &Table<Level4> {
		unsafe { self.p4.get() }
	}
	/// Returns a mutable refarance to Page table 4
	...
	/// Unmaps the givan page and adds all freed frames to the givan
	/// `FrameAllocator`
